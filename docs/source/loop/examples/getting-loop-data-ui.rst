...
The way this tutorial is structured is for you to follow along so that
you can get a greater understanding of how the Loop’s UI works. If you
have any problems or requests contact support@bluecats.com.

Table of Contents
-----------------

-  `Logging into Loop <>`__
-  `Getting Data into Loop <>`__

Logging into the Loop Dashboard
-------------------------------

1. Firstly go ahead and login
   `here <http://bclabs.loop.bluecats.com/>`__

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/loop-login.png
      :alt: Loop Login

      Loop Login

2. You should be brought to the Loop homepage
3. Once you are there, click on the top left icon (with three lines) to
   expand the menu.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/menu-expander.png
      :alt: Menu Expander

      Menu Expander

4. You should now be able to see the names of the icons. Click on
   Things.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/menu-expanded.png
      :alt: Menu Expanded
...
.. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/things-manager.png
   :alt: Things Manager
...
So let us say that you have 1 Beacon (BlueCats or a 3rd Party) and 1
Edge that you want to put into Loop of an objectType. For our example we
are going to make one Beacon that is of the type Equipment, and the Edge
will be a Device to track the data.
...
1. First we are going to click on the ‘Create’ button.
   ...
   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/create-things.png
      :alt: Create Things

      Create Things

2. This will bring us to a screen that will allow us to choose what
   group owns the object and also what type of object it is.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/create-thing-menu.png
      :alt: Create Things Menu

      Create Things Menu

3. For our purposes, we are going to select BlueCats Labs. It is likely
   you will have different groups here.

Group Hierarchy
~~~~~~~~~~~~~~~

The groups have a hierarchy. For example, if something has a hierarchy
like this:
...
BlueCats will have ownership of everything underneath it, which is
everything that BlueCats Labs and BlueCats Austin have. However,
BlueCats Labs cannot see everything BlueCats owns or what BlueCats
Austin owns.

You will probably have a good idea of your group’s hierachy and
structure. If not, think about it before, but don’t worry. You can
always change it.

Moving on, after selecting your group, you are going to select your
thing’s objectType. We are using the objectType Equipment. You most
likely have different objectTypes.

Determining Object Types
~~~~~~~~~~~~~~~~~~~~~~~~

You will probably have different objectTypes available to you. You will
have to discuss this with your organization with how you want to set
this up. Try to match the objectType best with what you are tracking.
Like Equipment for a thing or Person for a Person. Loop does not care
what you pick. It is entirely up to you. Don’t worry if you can’t
decide! You can always change it.

.. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/equipment-select.png
   :alt: Equipment Select

   Equipment Select

5. For the next part, you probably will have different fields available
   to you. Try to fill those in the best you can. For Type, we are going
   to put Car for this example and the Beacon’s serial Number
   ``50000B8A``.
6. Then click Save.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/equipment-save.png
      :alt: Equipment Save

      Equipment Save

So some of you might be saying, woah there!! I have a 3rd party Beacon.
What am I supposed to do with that? Well, for now if you do not have
Bluetooth MAC or anything for that Beacon, put a placeholder like
equipment1. We will change that to the 3rd party Beacon’s Bluetooth MAC
address later.
...
`Link
Identifiers <https://bluecats.github.io/documentation/loop/events#internal-event-types>`__
are what allow you to report events for a specific object to the Loop
API. This can be bcId (bluecats identifier), Eddystone UID, iBeacon,
bluetooth address, the Edge Mac, and more.
...
2. Sign in
3. Make sure you have selected your Team. If it is not, click the menu
   and click the right team for, which your Beacon belongs.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/bc-team-select.png
      :alt: Beacon Menu Select

      Beacon Menu Select

4. Go to the Beacons Tab.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/beacon-menu-select.png
      :alt: Beacon Menu Select

      Beacon Menu Select

5. Go to the search bar and type in your Beacon serial number

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/beacon-search.png
      :alt: Beacon Search

      Beacon Search

6. You should find your Beacon and it should look like this

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/beacon-found.png
      :alt: Beacon Found

      Beacon Found

We are going to look for Eddystone UID identifier. If your Beacon is in
the right mode, then it should show the identifier you are looking for.
If not, put your Beacon in the right mode and update it with BC Reveal.

These are the main types of eventIDs available
...
+=======================+=======================+=======================+
| iBeacon               | {iBeaconIDIdentifier} | ``5f2048a84e4d11e89c2 |
|                       |                       | dfa7ae01bbebc425005`` |
+-----------------------+-----------------------+-----------------------+
| Eddystone UID         | {eddyUIDIdentifier}   | ``AAFFAAFFAAFFAAFFAAF |
|                       |                       | F00000001FC43``       |
+-----------------------+-----------------------+-----------------------+
| Bluetooth Address     | {eddyUIDIdentifier}   | ``A0E6F854F61B``      |
+-----------------------+-----------------------+-----------------------+

A recommendation we have, is once you find the Bluetooth MAC address for
a 3rd Party Beacon. Plug that MAC address as the Serial Number field if
it is required. Also, if you have a lable maker. Labeling the 3rd party
Beacons with the MAC address is usually pretty helpful.
...
1. Now we are going to click on the Beacon radio button (pictured below)
   so that we can create a link identifier for it.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/beacon-link-select.png
      :alt: Beacon Link Select

      Beacon Link Select

2. Next we are going to select the identifer type. For our example, we
   are going to select Eddystone.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/beacon-link-types.png
      :alt: Beacon Link Identifier

      Beacon Link Identifier

3. We are going to paste the identifier in the field

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/link-uid.png
      :alt: Beacon Link Identifier

      Beacon Link Identifier

4. Now, we are going to click Link at the bottom of the page.
5. Once we click link, we should see a link identifier show up like
   this.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/link-identifier.png
      :alt: Beacon Link Identifier

      Beacon Link Identifier

You can technically have multiple types of link identifiers if you want.
But for most cases you should only need one.

Now that we have our object set up, we are going to finally set up our
Edge Relay by creating a Device in Loop and then have the Edge forward
the Data to Loop.
...
4. Fill out all of the Edge fields that are pertinent to you.
   ...
   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/edge-fields.png
      :alt: Create Things Menu
...
5. Next, click save.
   ...
   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/save+button.png
      :alt: Save

      Save

6. After, setup you can setup the Edge link identifier. The Edge just
   needs the Edge MAC located on the bottom.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/edge-mac.JPG
      :alt: Edge Mac

      Edge Mac

7. Once you locate the Edge MAC, click on the Edge Relay radio button.
   Fill in the Edge MAC, then remove colons.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/edge-link-setup.png
      :alt: Edge Link Mac Setup

      Edge Link Mac Setup

8. Then click Link, and your edge-link will look like this.

   .. figure:: https://s3-us-west-1.amazonaws.com/github-photos/DeveloperDocs/Loop/edge-link-identifier.png
      :alt: Edge Link Identifier
