...
[Start Configuring Edge Applications](getting-started-edge-applications#bluecats-edge-applications---overview) or continue below by connecting your Edge using the WiFi Setup.
